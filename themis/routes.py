...
from themis.models.responses import EvaluationResponse, PetitionResponse
from themis.controller import evaluate_petition, process_petition
...
#     return evaluate_petition(await file.read(), expected_id, provider_name=PROVIDER)
